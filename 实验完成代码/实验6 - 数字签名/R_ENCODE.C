 ...
 */
int R_EncodePEMBlock (unsigned char *encodedBlock, unsigned int *encodedBlockLen, unsigned char *block, unsigned int blockLen)
{
...
int R_DecodePEMBlock (unsigned char *block, unsigned int *blockLen, unsigned char *encodedBlock, unsigned int encodedBlockLen)
{
  int status;
  unsigned int i, lastLen;
...
static void EncodeQuantum (unsigned char encodedQuantum[4], unsigned char quantum[3])
{
  UINT4 temp;
...
static int DecodeQuantum (unsigned char quantum[3], unsigned char encodedQuantum[4])
{
  UINT4 temp;
  unsigned int a, b, c, d;
...
static void EncodeLastQuantum (unsigned char encodedQuantum[4], unsigned char *quantum, unsigned int quantumLen)
{
  UINT4 temp;
  unsigned int a, b, c, d;
...
static int DecodeLastQuantum (unsigned char *quantum, unsigned int *quantumLen, unsigned char encodedQuantum[4])
{
  UINT4 temp;
  unsigned int a, b, c, d;
